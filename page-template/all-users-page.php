						...
						<tbody>
							...
							//echo '<pre class="debug">';print_r($claims);echo '</pre>';
						  	...
						  	<tr>
								...
								<td class="text-center"><a href="<?php echo get_author_posts_url($user->ID); ?>" class="btn btn-default btn-block">View client details <i class="fa fa-chevron-right"></i></a></th>
						  	</tr>
						  	<?php } ?>
